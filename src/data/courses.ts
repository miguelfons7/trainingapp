...
export const courses: Course[] = [
  ...
  },
  {
    ...
    description:
      'Explore Via Trading\'s retail partner programs, product categories, and merchandise offerings. Understand what we sell, how programs work, and what makes each one unique.',
    icon: 'Package',
    estimatedTime: '~45 min',
