...
export const retailPrograms: RetailProgram[] = [
  ...
  // === WAYFAIR ===
  {
    ...
    category: 'Furniture',
    type: 'Mixed',
    condition: 'Customer Returns, Shelf Pull, Excess, Clearance, Salvage',
    pricingModel: '% of retail / flat rate',
    priceRange: '$133 – $31,370',
    fob: 'CA, FL, IL, MD, TX',
    ...
    keyFeatures: [
      '5 load types including Salvage',
  ...
  // === ZAPPOS ===
  {
    ...
    type: 'Manifested',
    condition: 'Shelf Pulls & Customer Returns',
    pricingModel: '13.5% of retail',
    priceRange: '$0 – $127,134',
    fob: 'CA & KY',
    products: 'Shoes, clothing, handbags, backpacks, and accessories',
    brands: 'Adidas, Calvin Klein, Cole Haan, Crocs, Hoka, Jordan, Kate Spade, Levi\'s, Michael Kors, Nike, PUMA, Sam Edelman, Steve Madden, UGG, Under Armour, Vans, and more',
    keyFeatures: [
      'Manifested with item-level detail',
      'Two condition types: Shelf Pulls and Customer Returns',
      'Part of Via Trading\'s WeSolveReturns (WSR) program',
      'Shoes, clothing, and accessories',
      'FOB California and Kentucky',
    ],
    status: 'active',
  },
